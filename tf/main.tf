...
resource "aws_launch_configuration" "as_conf" {
  ...
  user_data              = <<-EOF
      ...
      sudo apt-get -y -qq install fail2ban git rdiff-backup libpq-dev uwsgi uwsgi-plugin-python3 nginx unzip python-is-python3
      sudo apt-get -y -qq install python3-pip python3-venv virtualenv gdal-bin
